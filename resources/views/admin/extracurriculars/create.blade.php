...
<div class="mb-8">
    ...
    <h3 class="text-2xl font-black text-slate-800 tracking-tight leading-tight">Tambah Ekskul Baru</h3>
    <p class="text-[10px] text-slate-400 font-bold uppercase tracking-widest mt-1">Buat program ekstrakurikuler baru untuk siswa</p>
</div>

<div class="max-w-5xl" x-data="eskulForm()">
    <form action="{{ route('admin.extracurriculars.store') }}" method="POST" enctype="multipart/form-data" @submit="loading = true">
        @csrf
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea name="description" rows="8" 
                                      ...
                                      placeholder="Jelaskan mengenai kegiatan, jadwal, atau prestasi dari ekskul ini...">{{ old('description') }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="lg:col-span-4 space-y-6">
                <div class="bg-white rounded-[2rem] shadow-sm border border-slate-100 p-8 flex flex-col items-center">
                    ...
                    <div class="mt-6 text-center">
                        <p class="text-[9px] text-slate-400 font-bold uppercase tracking-[0.15em] leading-relaxed">Format: JPG, PNG, WEBP<br>Maksimal: 3MB<br>Rasio 16:9 disarankan</p>
                    </div>
