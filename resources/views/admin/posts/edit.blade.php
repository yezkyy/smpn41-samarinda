                    ...
                    <div class="space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <textarea name="content" rows="15" 
                                ...
                                placeholder="Tuliskan isi berita secara lengkap di sini..." required>{{ old('content', $post->content) }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="bg-white rounded-[2rem] shadow-sm border border-slate-100 p-8">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="space-y-2" x-data="{ 
                            open: false, 
                            value: '{{ $post->status }}',
                            get label() { return this.value === 'published' ? 'Terbitkan' : 'Simpan Draft' }
                        }">
                        ...
                        <!-- Thumbnail -->
                        <div class="space-y-4" x-data="{ photoPreview: '{{ $post->thumbnail ? asset('storage/' . $post->thumbnail) : '' }}' }">
                            <label class="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] ml-1">Gambar Sampul</label>
                            
                            <!-- Preview Box -->
                            <div class="relative w-full h-48 bg-slate-50 rounded-2xl overflow-hidden border-2 border-dashed border-slate-200 flex items-center justify-center group text-center">
                            ...
                            <p class="text-[10px] text-slate-400 text-center italic">Biarkan kosong jika tidak ingin mengubah thumbnail.</p>
                        </div>
                    </div>
                </div>
